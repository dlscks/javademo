...
public class Java078_class {
	...
	// [출력결과]를 참조하여 main()메소드를 구현하세요
		...
		CreaditCard[] cc= new CreaditCard[3];
		cc[0] = new CreaditCard("기업은행", "42523-52325", 100000);
		cc[1] = new CreaditCard("하나은행", "52253-22623", 153000);
		cc[2] = new CreaditCard("신한은행", "16239-95235", 256000);
		int sum = 0;
