...
public class Java125_RegEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(sn.matches(".*[a-zA-z]_*"));
		
		//sn변수에 숫자 0-9가 포함되어 있으면 true 아니면 false을 리턴한다.
		System.out.println(sn.matches(".*[0-0].*"));
		...
		//sb변수에 저장된 값이 2로 시작되면 true 아니면 false을 리턴
		System.out.println(sb.matches("2.*"));
		
		//sb변수에 저장된 값이 2개로 시작되면 true 아니면 false을 리턴한다.
		System.out.println(sb.matches("2.*5"));
		
		//st변수에 저장된 값이 a이거나 b로시작하고 임의문자가 5개이면 true 아니면 false을 리턴
